  ...
  return (
    <>
      ...
      <main className="lesson-page">
        ...
        {lesson13.sentences[0] && (
          <SpeakingGame target={lesson13.sentences[0]} progressTotal={1} progressCompleted={speakingCompleted} onAttemptComplete={() => setSpeakingCompleted(1)} />
        )}
